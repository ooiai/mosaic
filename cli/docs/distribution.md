...
```bash
curl -fsSL https://github.com/ooiai/mosaic/releases/latest/download/install.sh | bash -s -- --version v0.2.0-beta.3
```
...
```bash
./cli/scripts/package_release_asset.sh --version v0.2.0-beta.3 --target aarch64-apple-darwin
```
