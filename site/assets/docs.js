(function () {
  ...
  const index = {
    en: [
      ...
      { title: "TUI Guide", url: "tui.html", desc: "Chat-first full-screen terminal UI usage and shortcuts", keywords: "tui terminal ui focus inspector session shortcut ctrl+j ctrl+n" },
    ...
    zh: [
      ...
      { title: "TUI 教程", url: "tui.html", desc: "chat-first 全屏终端界面使用与快捷键", keywords: "tui terminal ui 终端 界面 快捷键 focus inspector 会话" },
