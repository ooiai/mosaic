...
本仓库也包含了完整的 Rust CLI 工作区，用于本地 Agent 工作流：

- 工作区：`cli/`
- 命令二进制：`mosaic`
- 命令文档与运行指南：`cli/README.md`
- 能力映射与回归文档：`cli/docs/parity-map.md`、`cli/docs/regression-runbook.md`
...
- `make cli-release-assets v=v0.2.0-beta.5 t=aarch64-apple-darwin` - 为指定目标打包发布产物
- `make cli-release-manifests v=v0.2.0-beta.5 assets=dist/v0.2.0-beta.5 out=dist/v0.2.0-beta.5` - 生成 Homebrew/Scoop 清单
