...
fn persists_and_recovers_route_decision_metadata() {
    ...
    trace.bind_route_decision(RouteDecisionTrace {
        ...
        route_kind: Some(mosaic_inspect::RouteKind::Skill),
        ...
        capability_source_kind: Some(mosaic_inspect::CapabilitySourceKind::NativeSkill),
        source_name: Some("summarize".to_owned()),
        source_path: None,
        source_version: None,
        execution_target: Some(mosaic_inspect::ExecutionTarget::Local),
        orchestration_owner: Some(mosaic_inspect::OrchestrationOwner::Runtime),
        policy_source: None,
        sandbox_scope: None,
...
fn persists_and_recovers_skill_trace_source_metadata() {
    ...
    trace.skill_calls.push(SkillTrace {
        ...
        capability_source_kind: Some(mosaic_inspect::CapabilitySourceKind::MarkdownSkillPack),
        source_name: Some("operator_note".to_owned()),
