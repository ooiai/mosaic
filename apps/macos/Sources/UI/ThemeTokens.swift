...
public struct ThemeTokens: Sendable {
    ...
    public static func current(for colorScheme: ColorScheme) -> ThemeTokens {
        ...
        default:
            ThemeTokens(
                windowBackground: Color(red: 0.972, green: 0.972, blue: 0.975),
                sidebarBackground: Color(red: 0.914, green: 0.944, blue: 0.973),
                ...
                codeBackground: Color(red: 0.936, green: 0.946, blue: 0.973),
                logBackground: Color(red: 0.944, green: 0.949, blue: 0.956),
                border: Color.black.opacity(0.065),
                accent: Color(red: 0.14, green: 0.39, blue: 0.78),
                accentMuted: Color(red: 0.83, green: 0.89, blue: 0.97),
                selection: Color(red: 0.86, green: 0.91, blue: 0.97),
